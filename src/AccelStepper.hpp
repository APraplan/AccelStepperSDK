...
/// application. To purchase a commercial license, contact apraplan@hotmail.com
///
...
// Use the system yield() whenever possible, since some platforms require it for housekeeping, especially
// ESP8266
